...
- 一键 **Raw / 预览** 切换，随时查看原始 Markdown 源码
...
- **固定 v1.0.3 版本：** [`markdown-reader-1.0.3-chrome.zip`](https://github.com/whieet/free-markdown-reader/releases/download/v1.0.3/markdown-reader-1.0.3-chrome.zip)
